...
public class CherryQuizUI : MonoBehaviour
{
    ...
    private QuestionCherry question;
    ...
    public void SetQuestion(QuestionCherry question)
    {
        this.question = question;
        switch (question.questionType)
        {
            case QuestionCherryType.TEXT:
                questionImage.transform.parent.gameObject.SetActive(false);
                break;
            case QuestionCherryType.IMAGE:
                ImageHolder();
                questionImage.transform.gameObject.SetActive(true);
                questionImage.sprite = question.questionImg;
                break;
            case QuestionCherryType.VIDEO:
                ImageHolder();
                questionVideo.transform.gameObject.SetActive(true);
                questionVideo.clip = question.questionVideo;
                questionVideo.Play();
                break;
            case QuestionCherryType.AUDIO:
                ImageHolder();
    ...
    {
        if (question.questionType == QuestionCherryType.AUDIO)
        {
