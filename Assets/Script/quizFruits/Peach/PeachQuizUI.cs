...
public class PeachQuizUI : MonoBehaviour
{
    ...
    private QuestionPeach question;
    ...
    public void SetQuestion(QuestionPeach question)
    {
        this.question = question;
        switch (question.questionType)
        {
            case QuestionPeachType.TEXT:
                questionImage.transform.parent.gameObject.SetActive(false);
                break;
            case QuestionPeachType.IMAGE:
                ImageHolder();
                questionImage.transform.gameObject.SetActive(true);
                questionImage.sprite = question.questionImg;
                break;
            case QuestionPeachType.VIDEO:
                ImageHolder();
                questionVideo.transform.gameObject.SetActive(true);
                questionVideo.clip = question.questionVideo;
                questionVideo.Play();
                break;
            case QuestionPeachType.AUDIO:
                ImageHolder();
    ...
    {
        if (question.questionType == QuestionPeachType.AUDIO)
        {
