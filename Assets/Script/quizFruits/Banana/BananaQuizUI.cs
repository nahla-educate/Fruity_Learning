...
public class BananaQuizUI : MonoBehaviour
{
    ...
    private QuestionBanana question;
    ...
    public void SetQuestion(QuestionBanana question)
    {
        this.question = question;
        switch (question.questionType)
        {
            case QuestionBananaType.TEXT:
                questionImage.transform.parent.gameObject.SetActive(false);
                break;
            case QuestionBananaType.IMAGE:
                ImageHolder();
                questionImage.transform.gameObject.SetActive(true);
                questionImage.sprite = question.questionImg;
                break;
            case QuestionBananaType.VIDEO:
                ImageHolder();
                questionVideo.transform.gameObject.SetActive(true);
                questionVideo.clip = question.questionVideo;
                questionVideo.Play();
                break;
            case QuestionBananaType.AUDIO:
                ImageHolder();
    ...
    {
        if (question.questionType == QuestionBananaType.AUDIO)
        {
