...
public class OrangeQuizUI : MonoBehaviour
{
    ...
    private QuestionOrange question;
    ...
    public void SetQuestion(QuestionOrange question)
    {
        this.question = question;
        switch (question.questionType)
        {
            case QuestionOrangeType.TEXT:
                questionImage.transform.parent.gameObject.SetActive(false);
                break;
            case QuestionOrangeType.IMAGE:
                ImageHolder();
                questionImage.transform.gameObject.SetActive(true);
                questionImage.sprite = question.questionImg;
                break;
            case QuestionOrangeType.VIDEO:
                ImageHolder();
                questionVideo.transform.gameObject.SetActive(true);
                questionVideo.clip = question.questionVideo;
                questionVideo.Play();
                break;
            case QuestionOrangeType.AUDIO:
                ImageHolder();
    ...
    {
        if (question.questionType == QuestionOrangeType.AUDIO)
        {
