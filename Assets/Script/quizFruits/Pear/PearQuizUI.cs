...
public class PearQuizUI : MonoBehaviour
{
    ...
    public void SetQuestion(QuestionPear question)
    {
        this.question = question;
        switch (question.questionType)
        {
            case QuestionPearType.TEXT:
                questionImage.transform.parent.gameObject.SetActive(false);
                break;
            case QuestionPearType.IMAGE:
                ImageHolder();
                questionImage.transform.gameObject.SetActive(true);
                questionImage.sprite = question.questionImg;
                break;
            case QuestionPearType.VIDEO:
                ImageHolder();
                questionVideo.transform.gameObject.SetActive(true);
                questionVideo.clip = question.questionVideo;
                questionVideo.Play();
                break;
            case QuestionPearType.AUDIO:
                ImageHolder();
    ...
    {
        if (question.questionType == QuestionPearType.AUDIO)
        {
