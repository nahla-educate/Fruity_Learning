...
public class AppleQuizUI : MonoBehaviour
{
    ...
    private QuestionApple question;
    ...
    public void SetQuestion(QuestionApple question)
    {
        this.question = question;
        switch (question.questionType)
        {
            case QuestionAppleType.TEXT:
                questionImage.transform.parent.gameObject.SetActive(false);
                break;
            case QuestionAppleType.IMAGE:
                ImageHolder();
                questionImage.transform.gameObject.SetActive(true);
                questionImage.sprite = question.questionImg;
                break;
            case QuestionAppleType.VIDEO:
                ImageHolder();
                questionVideo.transform.gameObject.SetActive(true);
                questionVideo.clip = question.questionVideo;
                questionVideo.Play();
                break;
            case QuestionAppleType.AUDIO:
                ImageHolder();
    ...
    {
        if (question.questionType == QuestionAppleType.AUDIO)
        {
